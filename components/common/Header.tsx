      ...
      <header className="bg-[#2D5016] text-white sticky top-0 z-50">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between py-4">
            ...
            <div className="flex items-center gap-4">
              <button className="hidden md:flex items-center gap-2 bg-orange-500 hover:bg-orange-600 px-4 py-2 rounded-full">
                <Phone size={18} />
                <span>Call Now</span>
              </button>
          ...
          {mobileMenuOpen && (
            <div className="md:hidden pb-4 space-y-2">
              <a href="#" className="block py-2 hover:text-green-200">
                Home
              </a>
              <a href="#" className="block py-2 hover:text-green-200">
                Products
