...
// export default function ShopCategories() {
//   const items = [
//     { image:"url(category/img1)", title: "Plants", desc: "Indoor & Outdoor Plants" },
//     { image:"url(category/img1)", title: "Medicine", desc: "Natural plant care solutions" },
//     { image:"url(category/img1)", title: "Equipment", desc: "Professional tools" },
//     { image:"url(category/img1)", title: "Fertilizers", desc: "Effective plant protection" },
//   ];
...
const products = [
  ...
  },
  {
    ...
    rating: 4.3,
    reviews: 34,
    image: "https://images.unsplash.com/photo-1590086782792-42dd2350140c?w=500",
  },
  {
    id: 4,
    name: "Snake Plant",
    ...
    rating: 4.8,
    reviews: 35,
    image: "https://images.unsplash.com/photo-1546548970-71785318a48a?w=500",
  },
];
