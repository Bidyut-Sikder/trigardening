  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      <div
        ...
        } bg-[#7A9B57] text-white flex flex-col transition-all duration-300`}
      >
        {/* Sidebar Header */}
        <div
        ...
        >
          {isSidebarOpen && (
            <div className="w-8 h-8 bg-[#7A9B57] rounded-full flex items-center justify-center">
              <span className="text-green-700 text-xl">
                <img src="/clinic-icon.png" alt="" />
              </span>
            </div>
          )}
          <button
        ...
        <div className="px-1 py-1 space-y-1">
          <button
            ...
            } py-3 rounded hover:text-[#2D5016] hover:bg-[#F5F5DC] transition`}
          >
            <Plus size={20} />
            {isSidebarOpen && <span className="text-xs ">New Chat</span>}
          </button>
          <button
            className={`w-full flex items-center ${
              isSidebarOpen ? "gap-2 px-2" : "justify-center"
          ...
          >
            <Search size={20} />
            {isSidebarOpen && <span className="text-xs">Search Chat</span>}
          </button>
          <button
            className={`w-full flex items-center ${
              isSidebarOpen ? "gap-2 px-2" : "justify-center"
          ...
          >
            <Upload size={20} />
            {isSidebarOpen && <span className="text-xs">Uploaded Media</span>}
          </button>
        </div>
          ...
          <div className="flex-1 px-4 py-6 overflow-y-auto">
            ...
            <div className="space-y-1">
              {historyItems.map((item, idx) => (
                <button
                  key={idx}
                  className={`w-full text-left px-3 py-2 rounded text-xs text-[#FFFFFF]  hover:text-[#2D5016]   transition ${
                    idx === 0
                      ? "bg-[#F5F5DC] text-[#2D5016]!"
                      : "hover:bg-[#F5F5DC] text-[#2D5016]"
                  }`}
                >
                  {item}
                </button>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 space-y-6">
          ...
          <div className="flex gap-3">
            ...
            <div className="bg-green-50 rounded-2xl rounded-tl-none px-4 py-3 max-w-md">
              <p className="text-gray-800 text-sm leading-relaxed">
                ট্রাইগার্ডেনিং এর, প্ল্যান্ট ক্লিনিকে আপনাকে স্বাগতম। আমি আপানার
                প্লান্ট ডক্টর। আপনার গাছের কোন সমস্যা নিয়ে আজ কথা বলতে চান?
                আক্রান্ত পাতার ছবি শেয়ার করুন অথবা আপনার প্রশ্ন লিখুন।
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-3">
            ...
            <div className="bg-green-50 rounded-2xl rounded-tl-none px-4 py-3 max-w-md">
              <p className="text-gray-800 text-sm leading-relaxed">
                অনুগ্রহ করে আপনার গাছের পাতার ছবিটি দিন আমি ছবিটি বিশ্লেষণ করে
                আপনাকে জানাচ্ছি।
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-3 justify-end">
            <div className="rounded-2xl  overflow-hidden shadow-lg max-w-md">
              <img src="/leaf.jpg" alt="Plant leaf" className="w-full h-auto" />
            </div>
            <div className="w-10 h-10 bg-green-200 rounded-full flex items-center justify-center shrink-0">
              <User size={20} className="text-green-700" />
            </div>
          ...
          <div className="flex gap-3">
            ...
            <div className="space-y-3 max-w-md">
              <div className="bg-green-50 rounded-2xl rounded-tl-none px-4 py-3">
                <p className="text-gray-800 text-sm leading-relaxed">
                  ছবিটি বিশ্লেষণ করে বেশ কিছু সম্ভাব্য সমস্যা পাওয়া গেছে। আপনার
                  গাছের সঠিক রোগ নির্ণয়ের জন্য, অনুগ্রহ করে নিচের প্রশ্নগুলোর
                  থেকে একটি বেছে নিন।
                </p>
              </div>
          ...
          <div className="flex gap-3">
            ...
            <div className="space-y-3 max-w-md">
              <div className="bg-green-50 rounded-2xl rounded-tl-none px-4 py-3">
                <p className="text-gray-800 text-sm leading-relaxed">
                  ধন্যবাদ। হলুদ দাগ সাধারণত পুষ্টির অভাব বা ছত্রাকের আক্রমণের
                  লক্ষণ হতে পারে। আপনি কি এই বিষয়ে আরও বিস্তারিত জানতে চান?
                </p>
              </div>
        ...
        {/* Input Area */}
        <div className="border- bg-white px-6 py-4">
...
//     <div className="flex h-screen bg-gray-50">
//       {/* Sidebar */}
//       <div className={`${isSidebarOpen ? 'w-64' : 'w-16'} bg-linear-to-b from-green-700 to-green-800 text-white flex flex-col transition-all duration-300`}>
//         {/* Sidebar Header */}
//         <div className="p-4 flex items-center gap-2">
//           <div className="w-8 h-8 bg-white rounded-full flex items-center justify-center">
//             <span className={`text-green-700 ${!isSidebarOpen && 'hidden'} text-xl"`}>🌱</span>
//           </div>
//           <button
//             onClick={() => setIsSidebarOpen(!isSidebarOpen)}
//             className="ml-auto text-white hover:bg-green-600 rounded p-1 transition"
//           >
//             <Menu size={20} />
//           </button>
//         </div>
...
//             <Plus size={`${isSidebarOpen ?18:28}`} className={`${!isSidebarOpen && 'ff'}`} />
//             {isSidebarOpen && <span className="text-sm">New Chat</span>}
//           </button>
//           <button className="w-full flex items-center gap-3 px-3 py-2 rounded hover:bg-green-600 transition">
//             <Search size={18} />
//             {isSidebarOpen && <span className="text-sm">Search Chat</span>}
//           </button>
//           <button className="w-full flex items-center gap-3 px-3 py-2 rounded hover:bg-green-600 transition">
//             <Upload size={18} />
//             {isSidebarOpen && <span className="text-sm">Uploaded Media</span>}
//           </button>
//         </div>
